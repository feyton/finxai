  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text
        ...
        FinxAI Help You Track Your Finance in style. From expenses to budgeting,
        we got you covered. Login to get started ➡️
      </Text>
      <Image
        resizeMode="contain"
        style={{height: 250, marginBottom: 10, marginTop: 10, marginLeft: -40}}
